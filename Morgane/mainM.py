...
#file
from Morgane.uniprotKB import *
from  Morgane.EnsemblEBI import *
from  Morgane.ncbiFunction import *
from  Morgane.refseq import *

#library
from requests import *
import time

def mainM(interface, data, outputfile, txt):
    #start
    start = time.time()
